...
import io.github.b_qiao.pers.lab.rest.ringcentral_engage_digital_client.handler.auth.Authentication;
import io.github.b_qiao.pers.lab.rest.ringcentral_engage_digital_client.handler.auth.HttpBasicAuth;
import io.github.b_qiao.pers.lab.rest.ringcentral_engage_digital_client.handler.auth.HttpBearerAuth;
import io.github.b_qiao.pers.lab.rest.ringcentral_engage_digital_client.handler.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "https://domain-name.api.engagement.dimelo.com/1.0";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{account_name}.api.{platform_hostname}/1.0",
      "API server endpoint",
      new HashMap<String, ServerVariable>() {{
        put("account_name", new ServerVariable(
          "Your own account name used as subdomain, it's the same as in the url of the engage digital service.",
          "domain-name",
          new HashSet<String>(
          )
        ));
        put("platform_hostname", new ServerVariable(
          "Depending on environment the base hostname is changing. In production, it's digital.ringcentral.com for NA customers and engagement.dimelo.com for historical customers. It's the same base hostname as in the url of engage digital service.",
          "engagement.dimelo.com",
          new HashSet<String>(
          )
        ));
      }}
