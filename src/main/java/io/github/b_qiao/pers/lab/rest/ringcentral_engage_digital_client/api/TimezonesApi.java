...
public class TimezonesApi {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 200 </td><td> List of all timezones </td><td>  -  </td></tr>
     </table>
   */
  public List<Timezone> getAllTimezones() throws ApiException {
    return getAllTimezonesWithHttpInfo().getData();
  }
   ...
   */
  public ApiResponse<List<Timezone>> getAllTimezonesWithHttpInfo() throws ApiException {
    ...
    GenericType<List<Timezone>> localVarReturnType = new GenericType<List<Timezone>>() {};

    return apiClient.invokeAPI("TimezonesApi.getAllTimezones", localVarPath, "GET", localVarQueryParams, localVarPostBody,
